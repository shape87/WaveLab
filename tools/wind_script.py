...
#                   tz = 'US/Eastern', ds =False)
    get_wind_data('baro2.nc','02092576', start_date='2016-10-07 00:00', end_date='2016-10-12 00:00', \
                  tz = 'US/Eastern', ds =False)
    get_wind_data('baro3.nc','0204347500', start_date='2016-10-07 00:00', end_date='2016-10-12 00:00', \
                  tz = 'US/Eastern', ds =False)
    get_wind_data('baro4.nc','0208117911', start_date='2016-10-07 00:00', end_date='2016-10-12 00:00', \
                  tz = 'US/Eastern', ds =False)
    get_wind_data('baro5.nc','0210869230', start_date='2016-10-07 00:00', end_date='2016-10-12 00:00', \
                  tz = 'US/Eastern', ds =False)
    get_wind_data('baro6.nc','02093206', start_date='2016-10-07 00:00', end_date='2016-10-12 00:00', \
                  tz = 'US/Eastern', ds =False)